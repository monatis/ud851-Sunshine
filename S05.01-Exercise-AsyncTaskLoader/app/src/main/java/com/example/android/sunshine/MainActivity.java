...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String[]> {
    ...
    private void loadWeatherData() {
        ...
        weatherBundle.putString("location", location);
        LoaderManager loaderManager = getSupportLoaderManager();
        Loader<String[]> weatherLoader = loaderManager.getLoader(WEATHER_LOADER);
        if(weatherLoader == null) {
            loaderManager.initLoader(WEATHER_LOADER, weatherBundle, this);
        } else {
            loaderManager.restartLoader(WEATHER_LOADER, weatherBundle, this);
        }
    }
